...
public class UTXOPool {
     ...
     */
    private HashMap<UTXO, Transaction.Output> H; //access variable from the same class constructoaccess variable from the same class constructor in javar in java
    ...
    /**
     * @return the transaction output corresponding to UTXO {@code utxo}, or null if {@code utxo} isverifySignature(PublicKey pubKey, byte[] message, byte[] signature)
     *         not in the pool.
     */
